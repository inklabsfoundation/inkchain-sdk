...
This tutorial illustrates the creation of a Hyperledger inkchain channel using
...
* getting started with Hyperledger inkchain see
[Building your first network](http://hyperledger-inkchain.readthedocs.io/en/latest/build_network.html).
* the configuration of a channel in Hyperledger inkchain and the internal
process of creating and updating see
[Hyperledger inkchain channel configuration](http://hyperledger-inkchain.readthedocs.io/en/latest/configtx.html)
* cryptographic generation see
[cryptogen](http://hyperledger-inkchain.readthedocs.io/en/latest/build_network.html#crypto-generator)
* configuration transaction generator see
[configtxgen](http://hyperledger-inkchain.readthedocs.io/en/latest/build_network.html#configuration-transaction-generator)
* configuration translation tool see
[configtxlator](https://github.com/hyperledger/inkchain/tree/master/examples/configtxupdate)

The following assumes an understanding of the Hyperledger inkchain network
(orderers and peers),
[protobuf](https://developers.google.com/protocol-buffers/),
and of Node application development, including the use of the
Javascript `Promise`.

The examples shown below are based on the `balance-transfer` sample application. see [Hyperledger inkchain Samples](http://hyperledger-inkchain.readthedocs.io/en/latest/samples.html)
  ...
  * get a sign-able channel definition in one of two ways
    ...
    2. build a custom definition
      ...
      * edit the readable text
      [more info](http://hyperledger-inkchain.readthedocs.io/en/latest/configtx.html)
...
[configtxgen tool](http://hyperledger-inkchain.readthedocs.io/en/latest/configtxgen.html)
is a binary file containing the Hyperledger inkchain configuration protobuf
...
Using the same configtx.yaml file used to generate your Hyperledger inkchain
...
to start the Hyperledger inkchain network to the configtxlator to get a
