...
var clientUtils = require('inkchain-client/lib/client-utils.js');
...
var proposalProto = grpc.load(path.join(__dirname, '../../../inkchain-client/lib/protos/peer/proposal.proto')).protos;
var ccProto = grpc.load(path.join(__dirname, '../../../inkchain-client/lib/protos/peer/chaincode.proto')).protos;
