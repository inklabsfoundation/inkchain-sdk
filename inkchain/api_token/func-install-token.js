...
test('\n\n***** inkchain flow: chaincode install *****\n\n', (t) => {
    ...
    inkUtils.installChaincode('org1',TOKEN_CHAINCODE_ID, TOKEN_CHAINCODE_PATH, TOKEN_VERSION, t, true)
        .then(() => {
            t.pass('Successfully installed chaincode in peers of organization "org1"');
            return inkUtils.installChaincode('org2',TOKEN_CHAINCODE_ID, TOKEN_CHAINCODE_PATH, TOKEN_VERSION, t, true);
        }, (err) => {
