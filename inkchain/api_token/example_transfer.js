...
test('\n\n***** End-to-end flow: invoke chaincode *****\n\n', (t) => {
    clientUtils.invokeChaincodeSigned('org1', 'token', 'v0', 'transfer', ["3c97f146e8de9807ef723538521fcecd5f64c79a", "INK", "1000"], "10", "hello world", "bab0c1204b2e7f344f9d1fbe8ad978d5355e32b8fa45b10b600d64ca970e0dc9", false)
        .then((result) => {
            t.pass('success');
            t.end();
