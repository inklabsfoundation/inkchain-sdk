...
/**
 * Transaction processing in inkchain v1.0 is a long operation spanning multiple
 ...
 *     passed the transaction id and the [validation code]{@link https://github.com/inklabsfoundation/inkchain/blob/v1.0.0/protos/peer/transaction.proto#L125}.
 *     See [registerTxEvent]{@link EventHub#registerTxEvent}
 * <li>register a "chaincode event listener" to get called when a specific
 *     [chaincode event]{@link https://github.com/inklabsfoundation/inkchain/blob/v1.0.0/examples/chaincode/go/eventsender/eventsender.go#L65}
 ...
 *     inkchain event listener can be written in any programming language. The following
 ...
 * <ul>
 *     <li>Node.js: this class. Source code can be found [here]{@link https://github.com/inklabsfoundation/inkchain-sdk-node/blob/v1.0.0/inkchain-client/lib/EventHub.js}
 * </ul>
 *
 * @example
...
var EventHub = class {
    ...
    constructor(clientContext) {
        ...
        this._stream = null;
        // inkchain connection state of this eventhub
    ...
    _connect(force) {
        ...
        logger.info('_connect - options %j', options);
     ...
     * @param {Object} block protobuf object which might contain the tx from the inkchain
     */
     ...
     * @param {Object} block protobuf object which might contain the chaincode event from the inkchain
     */
