...
>>>>>>> 2a93d38... 改名inkchain:inkchain-client/lib/msp/msp.js
		...
		if(this._intermediateCerts) {
			proto_inkchain_msp_config.setIntermediateCerts(this._intermediateCerts);
		}
		if(this._admins) {
			proto_inkchain_msp_config.setAdmins(this._admins);
		}
		if(this._organization_units) {
			//organizational_unit_identifiers
			proto_inkchain_msp_config.setOrganizationalUnitIdentifiers(this._organization_units);
		}
		proto_msp_config.setConfig(proto_inkchain_msp_config.toBuffer());
