...
var Orderer = class extends Remote {
	 ...
	 *                            [common.Envelope]{@link https://github.com/inklabsfoundation/inkchain/blob/v1.0.0/protos/common/common.proto#L132}
	 *                            that contains either a [ConfigUpdateEnvelope]{@link https://github.com/inklabsfoundation/inkchain/blob/v1.0.0/protos/common/configtx.proto#L70}
	 *                            or a [Transaction]{@link https://github.com/inklabsfoundation/inkchain/blob/v1.0.0/protos/peer/transaction.proto#L70}
...
//			broadcast.end();
	 ...
	 *                            be a protobuf encoded byte array of the
	 *                            [common.Envelope]{@link https://github.com/inklabsfoundation/inkchain/blob/v1.0.0/protos/common/common.proto#L132}
	 *                            that contains a [SeekInfo]{@link https://github.com/inklabsfoundation/inkchain/blob/v1.0.0/protos/orderer/ab.proto#L54}
	 *                            in the <code>payload.data</code> property of the envelope.
	 *                            The <code>header.channelHeader.type</code> must be set to
	 *                            [common.HeaderType.DELIVER_SEEK_INFO]{@link https://github.com/inklabsfoundation/inkchain/blob/v1.0.0/protos/common/common.proto#L44}
