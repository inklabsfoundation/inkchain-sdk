 ...
 * An instance must be configured with a <code>userContext</code> before it can be used to talk to the inkchain
...
var Client = class extends BaseClient {
	...
	/**
	 * Set dev mode to true or false to reflect the mode of the inkchain backend. See {@link Client#isDevMode} for details.
	 */
	setDevMode(devMode) {
	...
	/**
	 * In inkchain v1.0, a chaincode must be installed and instantiated before it
