...
/**
 * In inkchain v1.0, channels are the recommended way to isolate data and maintain privacy.
 * <br><br>
 * A Channel object captures the settings needed to interact with a inkchain backend in the
...
var Channel = class {
	 ...
	 * in the inkchain, call [createChannel()]{@link Client#createChannel}.
	 *
	 * @param {string} name - Name to identify the channel. This value is used as the identifier
	 *                        of the channel when making channel-aware requests with the inkchain,
	 ...
	 * signatures in messages received from the inkchain backend. For instance, after calling
	 ...
	 * lifecycle in the inkchain. The orderer will globally order the transactions in the
	 ...
	 * In inkchain v1.0, there is no difference in how the endorsing peers process a request
